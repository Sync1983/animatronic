...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(15)
		::nme::Lib_obj::setPackage(HX_CSTRING("Sync"),HX_CSTRING("XMLConverter"),HX_CSTRING("com.sync.xmlclonverter.XMLConverter"),HX_CSTRING("1.0.0"));
		...
		Void run(){
			HX_STACK_PUSH("*::_Function_1_1","ApplicationMain.hx",40);
			{
				...
				HX_STACK_LINE(49)
				{
					...
					Array< ::String > _g1 = ::Type_obj::getClassFields(hx::ClassOf< ::com::sync::xmlclonverter::Main >());		HX_STACK_VAR(_g1,"_g1");
					HX_STACK_LINE(49)
					while(((_g < _g1->length))){
						HX_STACK_LINE(49)
				...
				if ((hasMain)){
					HX_STACK_LINE(59)
					::Reflect_obj::callMethod(hx::ClassOf< ::com::sync::xmlclonverter::Main >(),::Reflect_obj::field(hx::ClassOf< ::com::sync::xmlclonverter::Main >(),HX_CSTRING("main")),Dynamic( Array_obj<Dynamic>::__new()));
				}
				else{
					HX_STACK_LINE(64)
					::com::sync::xmlclonverter::Main instance = ::Type_obj::createInstance(hx::ClassOf< ::com::sync::xmlclonverter::Main >(),Dynamic( Array_obj<Dynamic>::__new()));		HX_STACK_VAR(instance,"instance");
					HX_STACK_LINE(66)
		...
		HX_STACK_LINE(39)
		::nme::Lib_obj::create( Dynamic(new _Function_1_1()),(int)800,(int)480,(int)60,(int)0,(int((int((int((int((int((int((int((int((int((int(::nme::Lib_obj::HARDWARE) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int(::nme::Lib_obj::RESIZABLE))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0)),HX_CSTRING("XMLConverter"),null());
	}
return null();
}
...
Dynamic ApplicationMain_obj::getAsset( ::String inName){
	...
	HX_STACK_LINE(107)
	if (((inName == HX_CSTRING("img/Vikasa_output.png")))){
		HX_STACK_LINE(108)
		return ::nme::installer::Assets_obj::getBitmapData(HX_CSTRING("img/Vikasa_output.png"),null());
	}
	HX_STACK_LINE(114)
	if (((inName == HX_CSTRING("assets/Atlas.xml")))){
		HX_STACK_LINE(115)
		return ::nme::installer::Assets_obj::getText(HX_CSTRING("assets/Atlas.xml"));
	}
	HX_STACK_LINE(121)
	if (((inName == HX_CSTRING("assets/binary.bin")))){
		HX_STACK_LINE(122)
		return ::nme::installer::Assets_obj::getText(HX_CSTRING("assets/binary.bin"));
	}
	HX_STACK_LINE(128)
	if (((inName == HX_CSTRING("assets/img/Vikasa_output.png")))){
		HX_STACK_LINE(129)
		return ::nme::installer::Assets_obj::getBitmapData(HX_CSTRING("assets/img/Vikasa_output.png"),null());
	}
	HX_STACK_LINE(135)
	if (((inName == HX_CSTRING("assets/Vikasa_output")))){
		HX_STACK_LINE(136)
		return ::nme::installer::Assets_obj::getBytes(HX_CSTRING("assets/Vikasa_output"));
	}
	HX_STACK_LINE(142)
	if (((inName == HX_CSTRING("assets/XNLData.xml")))){
		HX_STACK_LINE(143)
		return ::nme::installer::Assets_obj::getText(HX_CSTRING("assets/XNLData.xml"));
	}
	HX_STACK_LINE(150)
	return null();
}
