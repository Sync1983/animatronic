...
::com::sync::xmlclonverter::Main_obj::__register();
...
::com::sync::xmlclonverter::AtlasParse_obj::__register();
::Xml_obj::__register();
...
::Type_obj::__boot();
::XmlType_obj::__boot();
::com::sync::xmlclonverter::AtlasParse_obj::__boot();
...
::com::sync::xmlclonverter::Main_obj::__boot();
