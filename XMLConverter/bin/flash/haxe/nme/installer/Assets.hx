...
class Assets {
	...
	private static function initialize ():Void {
		...
		if (!initialized) {
			...
			resourceClasses.set ("img/Vikasa_output.png", NME_img_vikasa_output_png);
			resourceTypes.set ("img/Vikasa_output.png", "image");
			resourceClasses.set ("assets/Atlas.xml", NME_assets_atlas_xml);
			resourceTypes.set ("assets/Atlas.xml", "text");
			resourceClasses.set ("assets/binary.bin", NME_assets_binary_bin);
			resourceTypes.set ("assets/binary.bin", "text");
			resourceClasses.set ("assets/img/Vikasa_output.png", NME_assets_img_vikasa_output_png);
			resourceTypes.set ("assets/img/Vikasa_output.png", "image");
			resourceClasses.set ("assets/Vikasa_output", NME_assets_vikasa_output);
			resourceTypes.set ("assets/Vikasa_output", "binary");
			resourceClasses.set ("assets/XNLData.xml", NME_assets_xnldata_xml);
			resourceTypes.set ("assets/XNLData.xml", "text");
