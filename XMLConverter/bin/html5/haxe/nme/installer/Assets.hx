...
class Assets {
	...
	private static function initialize ():Void {
		...
		if (!initialized) {
			...
			resourceNames.set ("img/Vikasa_output.png", "img/Vikasa_output.png");
			resourceTypes.set ("img/Vikasa_output.png", "image");
			
			
			resourceNames.set ("assets/Atlas.xml", "assets/Atlas.xml");
			resourceTypes.set ("assets/Atlas.xml", "text");
			
			
			resourceNames.set ("assets/binary.bin", "assets/binary.bin");
			resourceTypes.set ("assets/binary.bin", "text");
			
			
			resourceNames.set ("assets/img/Vikasa_output.png", "assets/img/Vikasa_output.png");
			resourceTypes.set ("assets/img/Vikasa_output.png", "image");
			
			
			resourceNames.set ("assets/Vikasa_output", "assets/Vikasa_output");
			resourceTypes.set ("assets/Vikasa_output", "binary");
			
			
			resourceNames.set ("assets/XNLData.xml", "assets/XNLData.xml");
