...
bool Reflect_obj::hasField( Dynamic o,::String field){
	HX_STACK_PUSH("Reflect::hasField","E:\\HaxeFoundation\\haxe/std/cpp/_std/Reflect.hx",24);
	HX_STACK_ARG(o,"o");
...
Dynamic Reflect_obj::field( Dynamic o,::String field){
	HX_STACK_PUSH("Reflect::field","E:\\HaxeFoundation\\haxe/std/cpp/_std/Reflect.hx",28);
	HX_STACK_ARG(o,"o");
	HX_STACK_ARG(field,"field");
	HX_STACK_LINE(28)
...
Dynamic Reflect_obj::callMethod( Dynamic o,Dynamic func,Dynamic args){
	HX_STACK_PUSH("Reflect::callMethod","E:\\HaxeFoundation\\haxe/std/cpp/_std/Reflect.hx",46);
	HX_STACK_ARG(o,"o");
...
Array< ::String > Reflect_obj::fields( Dynamic o){
	HX_STACK_PUSH("Reflect::fields","E:\\HaxeFoundation\\haxe/std/cpp/_std/Reflect.hx",53);
	HX_STACK_ARG(o,"o");
	HX_STACK_LINE(54)
	if (((o == null()))){
		HX_STACK_LINE(54)
...
bool Reflect_obj::isFunction( Dynamic f){
	HX_STACK_PUSH("Reflect::isFunction","E:\\HaxeFoundation\\haxe/std/cpp/_std/Reflect.hx",60);
	HX_STACK_ARG(f,"f");
	HX_STACK_LINE(60)
...
bool Reflect_obj::compareMethods( Dynamic f1,Dynamic f2){
	HX_STACK_PUSH("Reflect::compareMethods","E:\\HaxeFoundation\\haxe/std/cpp/_std/Reflect.hx",68);
	HX_STACK_ARG(f1,"f1");
	HX_STACK_ARG(f2,"f2");
	HX_STACK_LINE(69)
	if (((f1 == f2))){
...
bool Reflect_obj::isObject( Dynamic v){
	HX_STACK_PUSH("Reflect::isObject","E:\\HaxeFoundation\\haxe/std/cpp/_std/Reflect.hx",76);
	HX_STACK_ARG(v,"v");
	HX_STACK_LINE(77)
	if (((v == null()))){
		HX_STACK_LINE(77)
...
bool Reflect_obj::deleteField( Dynamic o,::String field){
	HX_STACK_PUSH("Reflect::deleteField","E:\\HaxeFoundation\\haxe/std/cpp/_std/Reflect.hx",83);
	HX_STACK_ARG(o,"o");
	HX_STACK_ARG(field,"field");
	HX_STACK_LINE(84)
	if (((o == null()))){
