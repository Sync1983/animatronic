...
Void Stage_obj::nmeOnJoystick( Dynamic inEvent,::String inType){
{
		...
		if (  ( _switch_1==HX_CSTRING("axisMove"))){
			struct _Function_2_1{
				inline static Array< Float > Block( ::native::display::Stage_obj *__this,Dynamic &inEvent){
			...
			HX_STACK_LINE(465)
			Array< Float > data = _Function_2_1::Block(this,inEvent);		HX_STACK_VAR(data,"data");
			HX_STACK_LINE(466)
			if (((data == null()))){
				HX_STACK_LINE(467)
...
Float Stage_obj::nmeDoProcessStageEvent( Dynamic inEvent){
	...
	switch( (int)(type)){
		...
		case (int)16: {
			struct _Function_2_1{
				inline static ::native::display::TouchInfo Block( ::native::display::Stage_obj *__this,Dynamic &inEvent){
			...
			HX_STACK_LINE(325)
			::native::display::TouchInfo touchInfo = _Function_2_1::Block(this,inEvent);		HX_STACK_VAR(touchInfo,"touchInfo");
			HX_STACK_LINE(326)
