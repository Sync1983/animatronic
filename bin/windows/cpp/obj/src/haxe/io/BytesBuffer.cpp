...
{
HX_STACK_PUSH("BytesBuffer::new","E:\\HaxeFoundation\\haxe/std/haxe/io/BytesBuffer.hx",42);
{
	HX_STACK_LINE(42)
...
::haxe::io::Bytes BytesBuffer_obj::getBytes( ){
	HX_STACK_PUSH("BytesBuffer::getBytes","E:\\HaxeFoundation\\haxe/std/haxe/io/BytesBuffer.hx",123);
	HX_STACK_THIS(this);
	HX_STACK_LINE(139)
