...
{
HX_STACK_PUSH("IntMap::new","E:\\HaxeFoundation\\haxe/std/cpp/_std/haxe/ds/IntMap.hx",28);
{
	HX_STACK_LINE(28)
...
Dynamic IntMap_obj::iterator( ){
	HX_STACK_PUSH("IntMap::iterator","E:\\HaxeFoundation\\haxe/std/cpp/_std/haxe/ds/IntMap.hx",53);
	HX_STACK_THIS(this);
	HX_STACK_LINE(54)
...
bool IntMap_obj::remove( int key){
	HX_STACK_PUSH("IntMap::remove","E:\\HaxeFoundation\\haxe/std/cpp/_std/haxe/ds/IntMap.hx",44);
	HX_STACK_THIS(this);
...
Dynamic IntMap_obj::get( int key){
	HX_STACK_PUSH("IntMap::get","E:\\HaxeFoundation\\haxe/std/cpp/_std/haxe/ds/IntMap.hx",36);
	HX_STACK_THIS(this);
	HX_STACK_ARG(key,"key");
	HX_STACK_LINE(36)
...
{
		HX_STACK_PUSH("IntMap::set","E:\\HaxeFoundation\\haxe/std/cpp/_std/haxe/ds/IntMap.hx",32);
		HX_STACK_THIS(this);
		HX_STACK_ARG(key,"key");
