...
Dynamic Lib_obj::load( ::String lib,::String prim,int nargs){
	HX_STACK_PUSH("Lib::load","E:\\HaxeFoundation\\haxe/std/cpp/Lib.hx",29);
...
Dynamic Lib_obj::loadLazy( ::String lib,::String prim,int nargs){
	HX_STACK_PUSH("Lib::loadLazy","E:\\HaxeFoundation\\haxe/std/cpp/Lib.hx",48);
	HX_STACK_ARG(lib,"lib");
	HX_STACK_ARG(prim,"prim");
	HX_STACK_ARG(nargs,"nargs");
	HX_STACK_LINE(49)
			...
			Dynamic e = __e;{
				...
				switch( (int)(nargs)){
					case (int)0: {
						...
						Void run(){
							HX_STACK_PUSH("*::_Function_3_1","E:\\HaxeFoundation\\haxe/std/cpp/Lib.hx",53);
							{
								HX_STACK_LINE(53)
					...
					case (int)2: {
						...
						Void run(Dynamic _1,Dynamic _2){
							HX_STACK_PUSH("*::_Function_3_1","E:\\HaxeFoundation\\haxe/std/cpp/Lib.hx",54);
							HX_STACK_ARG(_1,"_1");
							HX_STACK_ARG(_2,"_2");
							{
								HX_STACK_LINE(54)
					...
					case (int)3: {
						...
						Void run(Dynamic _1,Dynamic _2,Dynamic _3){
							HX_STACK_PUSH("*::_Function_3_1","E:\\HaxeFoundation\\haxe/std/cpp/Lib.hx",55);
							HX_STACK_ARG(_1,"_1");
							HX_STACK_ARG(_2,"_2");
							HX_STACK_ARG(_3,"_3");
							{
					...
					case (int)4: {
						...
						Void run(Dynamic _1,Dynamic _2,Dynamic _3,Dynamic _4){
							HX_STACK_PUSH("*::_Function_3_1","E:\\HaxeFoundation\\haxe/std/cpp/Lib.hx",56);
							HX_STACK_ARG(_1,"_1");
							HX_STACK_ARG(_2,"_2");
							HX_STACK_ARG(_3,"_3");
							HX_STACK_ARG(_4,"_4");
					...
					case (int)5: {
						...
						Void run(Dynamic _1,Dynamic _2,Dynamic _3,Dynamic _4,Dynamic _5){
							HX_STACK_PUSH("*::_Function_3_1","E:\\HaxeFoundation\\haxe/std/cpp/Lib.hx",57);
							HX_STACK_ARG(_1,"_1");
							HX_STACK_ARG(_2,"_2");
							HX_STACK_ARG(_3,"_3");
							HX_STACK_ARG(_4,"_4");
					...
					default: {
						...
						HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_Function_3_1,Dynamic,e1)
						Void run(Dynamic _1){
							HX_STACK_PUSH("*::_Function_3_1","E:\\HaxeFoundation\\haxe/std/cpp/Lib.hx",58);
							HX_STACK_ARG(_1,"_1");
							{
								HX_STACK_LINE(58)
								hx::Throw (e1->__GetItem((int)0));
...
{
		HX_STACK_PUSH("Lib::println","E:\\HaxeFoundation\\haxe/std/cpp/Lib.hx",93);
		HX_STACK_ARG(v,"v");
		HX_STACK_LINE(93)
		::__hxcpp_println(v);
	}
