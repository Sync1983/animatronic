...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(18)
		::nme::Lib_obj::setPackage(HX_CSTRING("Sync"),HX_CSTRING("Bones2"),HX_CSTRING("com.sync.bones2.Bones2"),HX_CSTRING("1.0.0"));
		...
		Void run(){
			HX_STACK_PUSH("*::_Function_1_1","ApplicationMain.hx",43);
			{
				...
				HX_STACK_LINE(53)
				{
					...
					Array< ::String > _g1 = ::Type_obj::getClassFields(hx::ClassOf< ::com::sync::bones2::Main >());		HX_STACK_VAR(_g1,"_g1");
					HX_STACK_LINE(53)
					while(((_g < _g1->length))){
						HX_STACK_LINE(53)
				...
				if ((hasMain)){
					HX_STACK_LINE(63)
					::Reflect_obj::callMethod(hx::ClassOf< ::com::sync::bones2::Main >(),::Reflect_obj::field(hx::ClassOf< ::com::sync::bones2::Main >(),HX_CSTRING("main")),Dynamic( Array_obj<Dynamic>::__new()));
				}
				else{
					HX_STACK_LINE(68)
		...
		HX_STACK_LINE(42)
		::nme::Lib_obj::create( Dynamic(new _Function_1_1()),(int)800,(int)480,(int)60,(int)0,(int((int((int((int((int((int((int((int((int((int(::nme::Lib_obj::HARDWARE) | int(::nme::Lib_obj::ALLOW_SHADERS))) | int((int)0))) | int((int)0))) | int((int)0))) | int(::nme::Lib_obj::RESIZABLE))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0)),HX_CSTRING("Bones2"),null(),null());
	}
return null();
}
