...
{
HX_STACK_PUSH("Uncompress::new","E:\\HaxeFoundation\\haxe/std/cpp/zip/Uncompress.hx",27);
{
	HX_STACK_LINE(27)
...
{
		HX_STACK_PUSH("Uncompress::close","E:\\HaxeFoundation\\haxe/std/cpp/zip/Uncompress.hx",39);
		HX_STACK_THIS(this);
		HX_STACK_LINE(39)
...
{
		HX_STACK_PUSH("Uncompress::setFlushMode","E:\\HaxeFoundation\\haxe/std/cpp/zip/Uncompress.hx",35);
		HX_STACK_THIS(this);
		HX_STACK_ARG(f,"f");
		HX_STACK_LINE(35)
...
Dynamic Uncompress_obj::this_run( ::haxe::io::Bytes src,int srcPos,::haxe::io::Bytes dst,int dstPos){
	HX_STACK_PUSH("Uncompress::this_run","E:\\HaxeFoundation\\haxe/std/cpp/zip/Uncompress.hx",31);
	HX_STACK_THIS(this);
...
::haxe::io::Bytes Uncompress_obj::run( ::haxe::io::Bytes src,Dynamic bufsize){
	HX_STACK_PUSH("Uncompress::run","E:\\HaxeFoundation\\haxe/std/cpp/zip/Uncompress.hx",43);
	HX_STACK_ARG(src,"src");
