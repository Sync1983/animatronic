...
{
HX_STACK_PUSH("Compress::new","E:\\HaxeFoundation\\haxe/std/cpp/zip/Compress.hx",28);
{
	HX_STACK_LINE(28)
...
{
		HX_STACK_PUSH("Compress::close","E:\\HaxeFoundation\\haxe/std/cpp/zip/Compress.hx",40);
		HX_STACK_THIS(this);
		HX_STACK_LINE(40)
...
{
		HX_STACK_PUSH("Compress::setFlushMode","E:\\HaxeFoundation\\haxe/std/cpp/zip/Compress.hx",36);
		HX_STACK_THIS(this);
		HX_STACK_ARG(f,"f");
		HX_STACK_LINE(36)
...
Dynamic Compress_obj::execute( ::haxe::io::Bytes src,int srcPos,::haxe::io::Bytes dst,int dstPos){
	HX_STACK_PUSH("Compress::execute","E:\\HaxeFoundation\\haxe/std/cpp/zip/Compress.hx",32);
	HX_STACK_THIS(this);
...
::haxe::io::Bytes Compress_obj::run( ::haxe::io::Bytes s,int level){
	HX_STACK_PUSH("Compress::run","E:\\HaxeFoundation\\haxe/std/cpp/zip/Compress.hx",44);
	HX_STACK_ARG(s,"s");
