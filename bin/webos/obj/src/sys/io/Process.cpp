...
{
HX_STACK_PUSH("Process::new","E:\\HaxeFoundation\\haxe/std/cpp/_std/sys/io/Process.hx",100);
{
	struct _Function_1_1{
		inline static Dynamic Block( Array< ::String > &args,::String &cmd){
			HX_STACK_PUSH("*::closure","E:\\HaxeFoundation\\haxe/std/cpp/_std/sys/io/Process.hx",101);
			{
				HX_STACK_LINE(101)
				try{
					HX_STACK_LINE(101)
...
{
		HX_STACK_PUSH("Process::close","E:\\HaxeFoundation\\haxe/std/cpp/_std/sys/io/Process.hx",115);
		HX_STACK_THIS(this);
		HX_STACK_LINE(115)
