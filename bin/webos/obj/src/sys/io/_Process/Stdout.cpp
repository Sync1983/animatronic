...
{
HX_STACK_PUSH("Stdout::new","E:\\HaxeFoundation\\haxe/std/cpp/_std/sys/io/Process.hx",64);
{
	HX_STACK_LINE(65)
	this->p = p;
	HX_STACK_LINE(66)
...
int Stdout_obj::readBytes( ::haxe::io::Bytes str,int pos,int len){
	HX_STACK_PUSH("Stdout::readBytes","E:\\HaxeFoundation\\haxe/std/cpp/_std/sys/io/Process.hx",76);
	HX_STACK_THIS(this);
...
int Stdout_obj::readByte( ){
	HX_STACK_PUSH("Stdout::readByte","E:\\HaxeFoundation\\haxe/std/cpp/_std/sys/io/Process.hx",70);
	HX_STACK_THIS(this);
	HX_STACK_LINE(71)
