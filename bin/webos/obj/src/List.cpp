...
{
HX_STACK_PUSH("List::new","E:\\HaxeFoundation\\haxe/std/List.hx",40);
{
	HX_STACK_LINE(40)
	this->length = (int)0;
}
...
Dynamic List_obj::iterator( ){
	HX_STACK_PUSH("List::iterator","E:\\HaxeFoundation\\haxe/std/List.hx",148);
	HX_STACK_THIS(this);
	struct _Function_1_1{
		inline static Dynamic Block( ::List_obj *__this){
			HX_STACK_PUSH("*::closure","E:\\HaxeFoundation\\haxe/std/List.hx",166);
			{
				...
				Dynamic run(){
					HX_STACK_PUSH("*::_Function_2_1","E:\\HaxeFoundation\\haxe/std/List.hx",168);
				...
				Dynamic run(){
					HX_STACK_PUSH("*::_Function_2_2","E:\\HaxeFoundation\\haxe/std/List.hx",171);
					HX_STACK_THIS(__this.mPtr);
					{
						HX_STACK_LINE(173)
...
bool List_obj::remove( Dynamic v){
	HX_STACK_PUSH("List::remove","E:\\HaxeFoundation\\haxe/std/List.hx",125);
	HX_STACK_THIS(this);
	HX_STACK_ARG(v,"v");
	HX_STACK_LINE(126)
...
bool List_obj::isEmpty( ){
	HX_STACK_PUSH("List::isEmpty","E:\\HaxeFoundation\\haxe/std/List.hx",108);
	HX_STACK_THIS(this);
	HX_STACK_LINE(108)
	return (this->h == null());
}
...
{
		HX_STACK_PUSH("List::push","E:\\HaxeFoundation\\haxe/std/List.hx",60);
		HX_STACK_THIS(this);
