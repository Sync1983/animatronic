...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(42)
		::nme::Lib_obj::create( Dynamic(new _Function_1_1()),(int)0,(int)0,(int)60,(int)0,(int((int((int((int((int((int((int((int((int((int(::nme::Lib_obj::HARDWARE) | int(::nme::Lib_obj::ALLOW_SHADERS))) | int((int)0))) | int((int)0))) | int((int)0))) | int(::nme::Lib_obj::RESIZABLE))) | int((int)0))) | int((int)0))) | int(::nme::Lib_obj::FULLSCREEN))) | int((int)0))) | int((int)0)),HX_CSTRING("Bones2"),null(),null());
	}
return null();
}
