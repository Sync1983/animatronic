...
bool Std_obj::is( Dynamic v,Dynamic t){
	HX_STACK_PUSH("Std::is","E:\\HaxeFoundation\\haxe/std/cpp/_std/Std.hx",23);
	HX_STACK_ARG(v,"v");
	HX_STACK_ARG(t,"t");
	HX_STACK_LINE(23)
...
::String Std_obj::string( Dynamic s){
	HX_STACK_PUSH("Std::string","E:\\HaxeFoundation\\haxe/std/cpp/_std/Std.hx",27);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(27)
...
int Std_obj::_int( Float x){
	HX_STACK_PUSH("Std::int","E:\\HaxeFoundation\\haxe/std/cpp/_std/Std.hx",31);
	HX_STACK_ARG(x,"x");
	HX_STACK_LINE(31)
	return ::__int__(x);
}
