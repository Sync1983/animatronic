	...
	HX_STACK_ARG(inStageClass,"inStageClass");
{
		...
		HX_BEGIN_LOCAL_FUNC_S6(hx::LocalFunc,_Function_1_1,Array< int >,inColour1,Array< Float >,inFrameRate1,Array< int >,inHeight1,Array< ::Dynamic >,stageClass,Dynamic,inOnLoaded1,Array< int >,inWidth1)
		...
		HX_STACK_LINE(80)
		create_main_frame( Dynamic(new _Function_1_1(inColour1,inFrameRate1,inHeight1,stageClass,inOnLoaded1,inWidth1)),inWidth1->__get((int)0),inHeight1->__get((int)0),inFlags,inTitle,(  (((inIcon == null()))) ? Dynamic(null()) : Dynamic(inIcon->nmeHandle) ));
	}
return null();
}
