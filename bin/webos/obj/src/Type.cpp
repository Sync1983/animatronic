...
::Class Type_obj::getClass( Dynamic o){
	HX_STACK_PUSH("Type::getClass","E:\\HaxeFoundation\\haxe/std/cpp/_std/Type.hx",35);
	HX_STACK_ARG(o,"o");
	HX_STACK_LINE(36)
...
::String Type_obj::getClassName( ::Class c){
	HX_STACK_PUSH("Type::getClassName","E:\\HaxeFoundation\\haxe/std/cpp/_std/Type.hx",56);
	HX_STACK_ARG(c,"c");
	HX_STACK_LINE(57)
	if (((c == null()))){
		HX_STACK_LINE(58)
...
::Class Type_obj::resolveClass( ::String name){
	HX_STACK_PUSH("Type::resolveClass","E:\\HaxeFoundation\\haxe/std/cpp/_std/Type.hx",66);
...
::Enum Type_obj::resolveEnum( ::String name){
	HX_STACK_PUSH("Type::resolveEnum","E:\\HaxeFoundation\\haxe/std/cpp/_std/Type.hx",73);
	HX_STACK_ARG(name,"name");
	HX_STACK_LINE(74)
	::Class result = ::Class_obj::Resolve(name);		HX_STACK_VAR(result,"result");
	HX_STACK_LINE(75)
...
Dynamic Type_obj::createInstance( ::Class cl,Dynamic args){
	HX_STACK_PUSH("Type::createInstance","E:\\HaxeFoundation\\haxe/std/cpp/_std/Type.hx",80);
	HX_STACK_ARG(cl,"cl");
...
Dynamic Type_obj::createEnum( ::Enum e,::String constr,Dynamic params){
	HX_STACK_PUSH("Type::createEnum","E:\\HaxeFoundation\\haxe/std/cpp/_std/Type.hx",90);
	HX_STACK_ARG(e,"e");
...
Dynamic Type_obj::createEnumIndex( ::Enum e,int index,Dynamic params){
	HX_STACK_PUSH("Type::createEnumIndex","E:\\HaxeFoundation\\haxe/std/cpp/_std/Type.hx",94);
	HX_STACK_ARG(e,"e");
...
Array< ::String > Type_obj::getClassFields( ::Class c){
	HX_STACK_PUSH("Type::getClassFields","E:\\HaxeFoundation\\haxe/std/cpp/_std/Type.hx",104);
	HX_STACK_ARG(c,"c");
	HX_STACK_LINE(104)
...
Array< ::String > Type_obj::getEnumConstructs( ::Enum e){
	HX_STACK_PUSH("Type::getEnumConstructs","E:\\HaxeFoundation\\haxe/std/cpp/_std/Type.hx",108);
	HX_STACK_ARG(e,"e");
	HX_STACK_LINE(108)
