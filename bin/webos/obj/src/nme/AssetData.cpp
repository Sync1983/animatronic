...
Void AssetData_obj::initialize( ){
{
		...
		if ((!(::nme::AssetData_obj::initialized))){
			HX_STACK_LINE(21)
			::nme::AssetData_obj::path->set(HX_CSTRING("assets/bins/binary.bin"),HX_CSTRING("assets/bins/binary.bin"));
			HX_STACK_LINE(22)
			{
				HX_STACK_LINE(22)
				::nme::AssetType value = ::Reflect_obj::field(hx::ClassOf< ::nme::AssetType >(),HX_CSTRING("binary").toUpperCase());		HX_STACK_VAR(value,"value");
				HX_STACK_LINE(22)
				::nme::AssetData_obj::type->set(HX_CSTRING("assets/bins/binary.bin"),value);
			}
			HX_STACK_LINE(23)
			::nme::AssetData_obj::path->set(HX_CSTRING("assets/img/Vikasa_output.png"),HX_CSTRING("assets/img/Vikasa_output.png"));
			HX_STACK_LINE(24)
			{
				HX_STACK_LINE(24)
				::nme::AssetType value = ::Reflect_obj::field(hx::ClassOf< ::nme::AssetType >(),HX_CSTRING("image").toUpperCase());		HX_STACK_VAR(value,"value");
				HX_STACK_LINE(24)
				::nme::AssetData_obj::type->set(HX_CSTRING("assets/img/Vikasa_output.png"),value);
			}
			HX_STACK_LINE(25)
			::nme::AssetData_obj::path->set(HX_CSTRING("img/Vikasa_output.png"),HX_CSTRING("img/Vikasa_output.png"));
			HX_STACK_LINE(26)
			{
				HX_STACK_LINE(26)
				::nme::AssetType value = ::Reflect_obj::field(hx::ClassOf< ::nme::AssetType >(),HX_CSTRING("image").toUpperCase());		HX_STACK_VAR(value,"value");
				HX_STACK_LINE(26)
				::nme::AssetData_obj::type->set(HX_CSTRING("img/Vikasa_output.png"),value);
			}
			HX_STACK_LINE(27)
			::nme::AssetData_obj::path->set(HX_CSTRING("bins/binary.bin"),HX_CSTRING("bins/binary.bin"));
			HX_STACK_LINE(28)
			{
				HX_STACK_LINE(28)
				::nme::AssetType value = ::Reflect_obj::field(hx::ClassOf< ::nme::AssetType >(),HX_CSTRING("binary").toUpperCase());		HX_STACK_VAR(value,"value");
				HX_STACK_LINE(28)
				::nme::AssetData_obj::type->set(HX_CSTRING("bins/binary.bin"),value);
			}
			HX_STACK_LINE(31)
