...
{
HX_STACK_PUSH("StringMap::new","E:\\HaxeFoundation\\haxe/std/cpp/_std/haxe/ds/StringMap.hx",27);
{
	struct _Function_1_1{
		inline static Dynamic Block( ){
			HX_STACK_PUSH("*::closure","E:\\HaxeFoundation\\haxe/std/cpp/_std/haxe/ds/StringMap.hx",28);
			{
...
Dynamic StringMap_obj::keys( ){
	HX_STACK_PUSH("StringMap::keys","E:\\HaxeFoundation\\haxe/std/cpp/_std/haxe/ds/StringMap.hx",50);
	HX_STACK_THIS(this);
	HX_STACK_LINE(51)
...
bool StringMap_obj::exists( ::String key){
	HX_STACK_PUSH("StringMap::exists","E:\\HaxeFoundation\\haxe/std/cpp/_std/haxe/ds/StringMap.hx",39);
	HX_STACK_THIS(this);
...
Dynamic StringMap_obj::get( ::String key){
	HX_STACK_PUSH("StringMap::get","E:\\HaxeFoundation\\haxe/std/cpp/_std/haxe/ds/StringMap.hx",35);
	HX_STACK_THIS(this);
	HX_STACK_ARG(key,"key");
	HX_STACK_LINE(35)
...
{
		HX_STACK_PUSH("StringMap::set","E:\\HaxeFoundation\\haxe/std/cpp/_std/haxe/ds/StringMap.hx",31);
		HX_STACK_THIS(this);
		HX_STACK_ARG(key,"key");
