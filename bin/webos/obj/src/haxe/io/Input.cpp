...
::String Input_obj::readLine( ){
	HX_STACK_PUSH("Input::readLine","E:\\HaxeFoundation\\haxe/std/haxe/io/Input.hx",127);
	HX_STACK_THIS(this);
	HX_STACK_LINE(128)
...
{
		HX_STACK_PUSH("Input::close","E:\\HaxeFoundation\\haxe/std/haxe/io/Input.hx",67);
		HX_STACK_THIS(this);
	}
return null();
}
...
int Input_obj::readByte( ){
	HX_STACK_PUSH("Input::readByte","E:\\HaxeFoundation\\haxe/std/haxe/io/Input.hx",37);
	HX_STACK_THIS(this);
	HX_STACK_LINE(39)
