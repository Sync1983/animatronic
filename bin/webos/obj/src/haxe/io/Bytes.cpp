...
{
HX_STACK_PUSH("Bytes::new","E:\\HaxeFoundation\\haxe/std/haxe/io/Bytes.hx",29);
{
	HX_STACK_LINE(30)
	this->length = length;
	HX_STACK_LINE(31)
...
::haxe::io::Bytes Bytes_obj::sub( int pos,int len){
	HX_STACK_PUSH("Bytes::sub","E:\\HaxeFoundation\\haxe/std/haxe/io/Bytes.hx",99);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Bytes::blit","E:\\HaxeFoundation\\haxe/std/haxe/io/Bytes.hx",68);
		HX_STACK_THIS(this);
		HX_STACK_ARG(pos,"pos");
...
::haxe::io::Bytes Bytes_obj::alloc( int length){
	HX_STACK_PUSH("Bytes::alloc","E:\\HaxeFoundation\\haxe/std/haxe/io/Bytes.hx",250);
...
::haxe::io::Bytes Bytes_obj::ofString( ::String s){
	HX_STACK_PUSH("Bytes::ofString","E:\\HaxeFoundation\\haxe/std/haxe/io/Bytes.hx",275);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(286)
	Array< unsigned char > a = Array_obj< unsigned char >::__new();		HX_STACK_VAR(a,"a");
	HX_STACK_LINE(287)
...
::haxe::io::Bytes Bytes_obj::ofData( Array< unsigned char > b){
	HX_STACK_PUSH("Bytes::ofData","E:\\HaxeFoundation\\haxe/std/haxe/io/Bytes.hx",324);
	HX_STACK_ARG(b,"b");
	HX_STACK_LINE(324)
