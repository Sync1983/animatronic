...
::String StringTools_obj::urlEncode( ::String s){
	HX_STACK_PUSH("StringTools::urlEncode","E:\\HaxeFoundation\\haxe/std/StringTools.hx",37);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(37)
...
::String StringTools_obj::urlDecode( ::String s){
	HX_STACK_PUSH("StringTools::urlDecode","E:\\HaxeFoundation\\haxe/std/StringTools.hx",62);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(62)
