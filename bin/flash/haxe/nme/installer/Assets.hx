...
class Assets {
	...
	private static function initialize ():Void {
		...
		if (!initialized) {
			...
			resourceClasses.set ("assets/bins/binary.bin", NME_assets_bins_binary_bin);
			resourceTypes.set ("assets/bins/binary.bin", "binary");
			...
			resourceClasses.set ("bins/binary.bin", NME_bins_binary_bin);
			resourceTypes.set ("bins/binary.bin", "binary");
